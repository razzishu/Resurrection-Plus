...
import static com.resurrection.launcher.AbstractFloatingView.TYPE_FOLDER;
import static com.resurrection.launcher.AbstractFloatingView.TYPE_ICON_SURFACE;
import static com.resurrection.launcher.AbstractFloatingView.TYPE_REBIND_SAFE;
import static com.resurrection.launcher.AbstractFloatingView.TYPE_WIDGETS_FULL_SHEET;
import static com.resurrection.launcher.AbstractFloatingView.getTopOpenViewWithType;
import static com.resurrection.launcher.Flags.allAppsBlur;
import static com.resurrection.launcher.Flags.refactorTaskbarUiState;
import static com.resurrection.launcher.LauncherAnimUtils.HOTSEAT_SCALE_PROPERTY_FACTORY;
import static com.resurrection.launcher.LauncherAnimUtils.SCALE_INDEX_WIDGET_TRANSITION;
import static com.resurrection.launcher.LauncherAnimUtils.SPRING_LOADED_EXIT_DELAY;
import static com.resurrection.launcher.LauncherAnimUtils.WORKSPACE_SCALE_PROPERTY_FACTORY;
import static com.resurrection.launcher.LauncherConstants.ActivityCodes.REQUEST_BIND_APPWIDGET;
import static com.resurrection.launcher.LauncherConstants.ActivityCodes.REQUEST_BIND_PENDING_APPWIDGET;
import static com.resurrection.launcher.LauncherConstants.ActivityCodes.REQUEST_CREATE_APPWIDGET;
import static com.resurrection.launcher.LauncherConstants.ActivityCodes.REQUEST_CREATE_SHORTCUT;
import static com.resurrection.launcher.LauncherConstants.ActivityCodes.REQUEST_HOME_ROLE;
import static com.resurrection.launcher.LauncherConstants.ActivityCodes.REQUEST_PICK_APPWIDGET;
import static com.resurrection.launcher.LauncherConstants.ActivityCodes.REQUEST_RECONFIGURE_APPWIDGET;
import static com.resurrection.launcher.LauncherConstants.SavedInstanceKeys.RUNTIME_STATE;
import static com.resurrection.launcher.LauncherConstants.SavedInstanceKeys.RUNTIME_STATE_CURRENT_SCREEN_IDS;
import static com.resurrection.launcher.LauncherConstants.SavedInstanceKeys.RUNTIME_STATE_PENDING_ACTIVITY_RESULT;
import static com.resurrection.launcher.LauncherConstants.SavedInstanceKeys.RUNTIME_STATE_PENDING_REQUEST_ARGS;
import static com.resurrection.launcher.LauncherConstants.SavedInstanceKeys.RUNTIME_STATE_PENDING_REQUEST_CODE;
import static com.resurrection.launcher.LauncherConstants.SavedInstanceKeys.RUNTIME_STATE_RECREATE_TO_UPDATE_THEME;
import static com.resurrection.launcher.LauncherConstants.SavedInstanceKeys.RUNTIME_STATE_WIDGET_PANEL;
import static com.resurrection.launcher.LauncherConstants.TraceEvents.DISPLAY_ALL_APPS_TRACE_METHOD_NAME;
import static com.resurrection.launcher.LauncherConstants.TraceEvents.DISPLAY_WORKSPACE_TRACE_METHOD_NAME;
import static com.resurrection.launcher.LauncherConstants.TraceEvents.ON_CREATE_EVT;
import static com.resurrection.launcher.LauncherConstants.TraceEvents.ON_NEW_INTENT_EVT;
import static com.resurrection.launcher.LauncherConstants.TraceEvents.ON_RESUME_EVT;
import static com.resurrection.launcher.LauncherConstants.TraceEvents.ON_START_EVT;
import static com.resurrection.launcher.LauncherConstants.TraceEvents.SINGLE_TRACE_COOKIE;
import static com.resurrection.launcher.LauncherPrefs.FIXED_LANDSCAPE_MODE;
import static com.resurrection.launcher.LauncherSettings.Favorites.CONTAINER_ALL_APPS;
import static com.resurrection.launcher.LauncherSettings.Favorites.CONTAINER_ALL_APPS_PREDICTION;
...
import static com.resurrection.launcher.LauncherSettings.Favorites.ITEM_TYPE_APPLICATION;
import static com.resurrection.launcher.LauncherState.ALL_APPS;
import static com.resurrection.launcher.LauncherState.EDIT_MODE;
import static com.resurrection.launcher.LauncherState.FLAG_MULTI_PAGE;
import static com.resurrection.launcher.LauncherState.FLAG_NON_INTERACTIVE;
import static com.resurrection.launcher.LauncherState.NORMAL;
import static com.resurrection.launcher.LauncherState.NO_OFFSET;
import static com.resurrection.launcher.LauncherState.NO_SCALE;
import static com.resurrection.launcher.LauncherState.SPRING_LOADED;
import static com.resurrection.launcher.Utilities.postAsyncCallback;
import static com.resurrection.launcher.Utilities.shouldEnableMouseInteractionChanges;
import static com.resurrection.launcher.Workspace.mapOverCellLayouts;
import static com.resurrection.launcher.anim.AnimatorListeners.forEndCallback;
import static com.resurrection.launcher.config.FeatureFlags.FOLDABLE_SINGLE_PAGE;
import static com.resurrection.launcher.config.FeatureFlags.MULTI_SELECT_EDIT_MODE;
import static com.resurrection.launcher.icons.BitmapRenderer.createHardwareBitmap;
import static com.resurrection.launcher.logging.KeyboardStateManager.KeyboardState.HIDE;
import static com.resurrection.launcher.logging.KeyboardStateManager.KeyboardState.SHOW;
import static com.resurrection.launcher.logging.StatsLogManager.EventEnum;
import static com.resurrection.launcher.logging.StatsLogManager.LAUNCHER_STATE_BACKGROUND;
import static com.resurrection.launcher.logging.StatsLogManager.LAUNCHER_STATE_HOME;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ALLAPPS_ENTRY_WITH_DEVICE_SEARCH;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ALLAPPS_EXIT;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ONRESUME;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ONSTOP;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_SPLIT_SELECTION_EXIT_HOME;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_SWIPELEFT;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_SWIPERIGHT;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_WIDGET_RECONFIGURED;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherLatencyEvent.LAUNCHER_LATENCY_STARTUP_ACTIVITY_ON_CREATE;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherLatencyEvent.LAUNCHER_LATENCY_STARTUP_VIEW_INFLATION;
import static com.resurrection.launcher.model.ItemInstallQueue.FLAG_ACTIVITY_PAUSED;
import static com.resurrection.launcher.model.ItemInstallQueue.FLAG_DRAG_AND_DROP;
import static com.resurrection.launcher.model.data.ItemInfoWithIcon.FLAG_NOT_PINNABLE;
import static com.resurrection.launcher.pageindicators.PaginationArrow.DISABLED_ARROW_OPACITY;
import static com.resurrection.launcher.pageindicators.PaginationArrow.FULLY_OPAQUE;
import static com.resurrection.launcher.popup.SystemShortcut.ADD_TO_HOME_SCREEN;
import static com.resurrection.launcher.popup.SystemShortcut.APP_INFO;
import static com.resurrection.launcher.popup.SystemShortcut.INSTALL;
import static com.resurrection.launcher.popup.SystemShortcut.REMOVE;
import static com.resurrection.launcher.popup.SystemShortcut.WIDGETS;
import static com.resurrection.launcher.states.RotationHelper.REQUEST_LOCK;
import static com.resurrection.launcher.states.RotationHelper.REQUEST_NONE;
import static com.resurrection.launcher.testing.shared.TestProtocol.LAUNCHER_ACTIVITY_STOPPED_MESSAGE;
import static com.resurrection.launcher.util.ItemInfoMatcher.forFolderMatch;
import static com.resurrection.launcher.util.SettingsCache.TOUCHPAD_NATURAL_SCROLLING;
...
import com.resurrection.launcher.DropTarget.DragObject;
import com.resurrection.launcher.accessibility.LauncherAccessibilityDelegate;
import com.resurrection.launcher.allapps.ActivityAllAppsContainerView;
import com.resurrection.launcher.allapps.AllAppsTransitionController;
import com.resurrection.launcher.allapps.DiscoveryBounce;
import com.resurrection.launcher.anim.AnimationSuccessListener;
import com.resurrection.launcher.anim.PropertyListBuilder;
import com.resurrection.launcher.apppairs.AppPairIcon;
import com.resurrection.launcher.celllayout.CellPosMapper;
import com.resurrection.launcher.celllayout.CellPosMapper.CellPos;
import com.resurrection.launcher.celllayout.CellPosMapper.TwoPanelCellPosMapper;
import com.resurrection.launcher.compat.AccessibilityManagerCompat;
import com.resurrection.launcher.compose.ComposeFacade;
import com.resurrection.launcher.config.FeatureFlags;
import com.resurrection.launcher.dagger.LauncherComponentProvider;
import com.resurrection.launcher.debug.TestEventEmitter;
import com.resurrection.launcher.debug.TestEventEmitter.TestEvent;
import com.resurrection.launcher.dragndrop.DragLayer;
import com.resurrection.launcher.dragndrop.DragView;
import com.resurrection.launcher.dragndrop.LauncherDragController;
...
import com.resurrection.launcher.keyboard.ViewGroupFocusHelper;
import com.resurrection.launcher.logger.LauncherAtom;
import com.resurrection.launcher.logger.LauncherAtom.ContainerInfo;
import com.resurrection.launcher.logger.LauncherAtom.WorkspaceContainer;
import com.resurrection.launcher.logging.FileLog;
import com.resurrection.launcher.logging.InstanceId;
import com.resurrection.launcher.logging.InstanceIdSequence;
import com.resurrection.launcher.logging.StartupLatencyLogger;
import com.resurrection.launcher.logging.StatsLogManager;
import com.resurrection.launcher.model.BgDataModel.Callbacks;
import com.resurrection.launcher.model.ItemInstallQueue;
import com.resurrection.launcher.model.ModelWriter;
import com.resurrection.launcher.model.StringCache;
...
import com.resurrection.launcher.model.data.ItemInfoWithIcon;
import com.resurrection.launcher.model.data.LauncherAppWidgetInfo;
import com.resurrection.launcher.model.data.PredictedContainerInfo;
import com.resurrection.launcher.model.data.WorkspaceData;
import com.resurrection.launcher.model.data.WorkspaceItemInfo;
import com.resurrection.launcher.pageindicators.PaginationArrow;
import com.resurrection.launcher.pm.PinRequestHelper;
import com.resurrection.launcher.popup.ArrowPopup;
import com.resurrection.launcher.popup.PopupController;
import com.resurrection.launcher.popup.SystemShortcut;
import com.resurrection.launcher.statemanager.StateManager;
import com.resurrection.launcher.statemanager.StateManager.StateHandler;
import com.resurrection.launcher.statemanager.StatefulActivity;
import com.resurrection.launcher.states.RotationHelper;
import com.resurrection.launcher.testing.TestLogging;
import com.resurrection.launcher.testing.shared.TestProtocol;
import com.resurrection.launcher.touch.AllAppsSwipeController;
import com.resurrection.launcher.touch.ItemClickHandler;
import com.resurrection.launcher.touch.ItemLongClickListener;
import com.resurrection.launcher.util.ActivityResultInfo;
import com.resurrection.launcher.util.BackPressHandler;
import com.resurrection.launcher.util.CannedAnimationCoordinator;
import com.resurrection.launcher.util.ContextTracker;
import com.resurrection.launcher.util.IntSet;
import com.resurrection.launcher.util.ItemInflater;
import com.resurrection.launcher.util.KeyboardShortcutsDelegate;
import com.resurrection.launcher.util.LauncherBindableItemsContainer;
import com.resurrection.launcher.util.PackageUserKey;
import com.resurrection.launcher.util.PendingRequestArgs;
import com.resurrection.launcher.util.PluginManagerWrapper;
import com.resurrection.launcher.util.RunnableList;
import com.resurrection.launcher.util.ScreenOnTracker;
import com.resurrection.launcher.util.ScreenOnTracker.ScreenOnListener;
import com.resurrection.launcher.util.SettingsCache;
import com.resurrection.launcher.util.StableViewInfo;
import com.resurrection.launcher.util.SystemUiController;
import com.resurrection.launcher.util.Themes;
import com.resurrection.launcher.util.Thunk;
import com.resurrection.launcher.util.TouchController;
import com.resurrection.launcher.util.TraceHelper;
import com.resurrection.launcher.util.WallpaperThemeManager;
import com.resurrection.launcher.views.FloatingIconView;
import com.resurrection.launcher.views.FloatingSurfaceView;
import com.resurrection.launcher.views.ListenerView;
import com.resurrection.launcher.views.OptionsPopupView;
import com.resurrection.launcher.views.ScrimView;
import com.resurrection.launcher.views.UpdateDeferrableView;
import com.resurrection.launcher.widget.LauncherAppWidgetHostView;
...
import com.resurrection.launcher.widget.PendingAddShortcutInfo;
import com.resurrection.launcher.widget.PendingAddWidgetInfo;
import com.resurrection.launcher.widget.PendingAppWidgetHostView;
import com.resurrection.launcher.widget.WidgetAddFlowHandler;
import com.resurrection.launcher.widget.WidgetManagerHelper;
import com.resurrection.launcher.widget.WidgetVisibilityTracker;
import com.resurrection.launcher.widget.custom.CustomWidgetManager;
import com.resurrection.launcher.widget.model.WidgetsListBaseEntry;
import com.resurrection.launcher.widget.picker.WidgetsFullSheet;
import com.resurrection.launcher.widget.picker.model.WidgetPickerDataProvider;
...
public class Launcher extends StatefulActivity<LauncherState>
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (BuildCompat.isAtLeastV()
                && com.resurrection.launcher.Flags.enableTwoPaneLauncherSettings()) {
    ...
    private void updateFixedLandscape() {
        if (!com.resurrection.launcher.Flags.oneGridSpecs()) {
            return;
        }
    ...
    /**
     * $ adb shell dumpsys activity com.resurrection.launcher.Launcher [--all]
     */
    @Override
     ...
     * {@link com.resurrection.launcher.uioverrides.QuickstepLauncher}
     */
    ...
    public boolean openWidgetPicker() {
        if (getPackageManager().isSafeMode()) {
            ...
            if (com.resurrection.launcher.Flags.enableWidgetPickerRefactor() &&
