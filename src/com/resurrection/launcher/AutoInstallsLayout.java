...
import static com.resurrection.launcher.provider.LauncherDbUtils.itemIdMatch;
import static com.resurrection.launcher.util.UserIconInfo.TYPE_CLONED;
import static com.resurrection.launcher.util.UserIconInfo.TYPE_WORK;
...
import com.resurrection.launcher.qsb.QsbContainerView;
...
public class AutoInstallsLayout {
    ...
    protected static String getAttributeValue(XmlPullParser parser, String attribute) {
        String value = parser.getAttributeValue(
                "http://schemas.android.com/apk/res-auto/com.resurrection.launcher", attribute);
        if (value == null) {
