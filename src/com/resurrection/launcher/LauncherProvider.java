 ...
 * Each row in the resurrection database corresponds to a single item on the workspace (often
...
public class LauncherProvider extends ContentProvider {
    ...
    /**
     * $ adb shell dumpsys activity provider com.resurrection.launcher
     */
    @Override
