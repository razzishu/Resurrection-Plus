...
import com.resurrection.launcher.BuildConfig.APPLICATION_ID
import com.resurrection.launcher.R
import com.resurrection.launcher.dagger.LauncherComponentProvider.appComponent
import com.resurrection.launcher.util.ContentProviderProxy
...
class LauncherCustomizationProvider : ContentProviderProxy() {
    ...
    private fun genericAccessException() =
        SecurityException(
            "Permission Denial: opening provider com.resurrection.launcher.graphics.LauncherCustomizationProvider (pid=${Binder.getCallingPid()}, uid=${Binder.getCallingUid()}) requires $BIND_WALLPAPER or $PERM_GRID_CONTROL"
        )
