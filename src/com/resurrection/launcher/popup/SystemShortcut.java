...
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_DISMISS_PREDICTION_UNDO;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_PRIVATE_SPACE_INSTALL_SYSTEM_SHORTCUT_TAP;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_PRIVATE_SPACE_UNINSTALL_SYSTEM_SHORTCUT_TAP;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_SYSTEM_SHORTCUT_APP_INFO_TAP;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_SYSTEM_SHORTCUT_DONT_SUGGEST_APP_TAP;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_SYSTEM_SHORTCUT_WIDGETS_TAP;
import static com.resurrection.launcher.widget.picker.model.data.WidgetPickerDataUtils.findAllWidgetsForPackageUser;
...
import com.resurrection.launcher.AbstractFloatingViewHelper;
...
import com.resurrection.launcher.views.Snackbar;
import com.resurrection.launcher.widget.WidgetsBottomSheet;
import com.resurrection.launcher.widget.picker.model.data.WidgetPickerData;
...
public abstract class SystemShortcut<T extends ActivityContext> extends ItemInfo
    ...
    public static final Factory<ActivityContext> PRIVATE_PROFILE_INSTALL =
            (context, itemInfo, originalView) -> {
                ...
                if (itemInfo.getTargetComponent() == null
                        || !(itemInfo instanceof com.resurrection.launcher.model.data.AppInfo)
    ...
    public static final Factory<ActivityContext> INSTALL =
            (activity, itemInfo, originalView) -> {
                ...
                if (itemInfo instanceof com.resurrection.launcher.model.data.AppInfo appInfo) {
