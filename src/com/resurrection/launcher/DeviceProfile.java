...
import static com.resurrection.launcher.InvariantDeviceProfile.INDEX_DEFAULT;
import static com.resurrection.launcher.InvariantDeviceProfile.INDEX_LANDSCAPE;
import static com.resurrection.launcher.InvariantDeviceProfile.INDEX_TWO_PANEL_LANDSCAPE;
import static com.resurrection.launcher.InvariantDeviceProfile.INDEX_TWO_PANEL_PORTRAIT;
import static com.resurrection.launcher.InvariantDeviceProfile.createDisplayOptionSpec;
import static com.resurrection.launcher.Utilities.dpiFromPx;
import static com.resurrection.launcher.deviceprofile.DevicePropertiesKt.createWindowBounds;
import static com.resurrection.launcher.folder.ClippedFolderIconLayoutRule.ICON_OVERLAP_FACTOR;
import static com.resurrection.launcher.icons.IconNormalizer.ICON_VISIBLE_AREA_FACTOR;
import static com.resurrection.launcher.testing.shared.ResourceUtils.INVALID_RESOURCE_HANDLE;
import static com.resurrection.launcher.testing.shared.ResourceUtils.pxFromDp;
import static com.resurrection.launcher.util.OverviewReleaseFlags.enableGridOnlyOverview;
...
import com.resurrection.launcher.CellLayout.ContainerType;
import com.resurrection.launcher.InvariantDeviceProfile.DisplayOptionSpec;
import com.resurrection.launcher.deviceprofile.AllAppsProfile;
import com.resurrection.launcher.deviceprofile.BottomSheetProfile;
import com.resurrection.launcher.deviceprofile.DeviceProperties;
import com.resurrection.launcher.deviceprofile.DropTargetProfile;
import com.resurrection.launcher.deviceprofile.FolderProfile;
import com.resurrection.launcher.deviceprofile.HotseatProfile;
import com.resurrection.launcher.deviceprofile.OverviewProfile;
import com.resurrection.launcher.deviceprofile.TaskbarProfile;
import com.resurrection.launcher.deviceprofile.WorkspaceProfile;
import com.resurrection.launcher.icons.DotRenderer;
import com.resurrection.launcher.model.data.ItemInfo;
import com.resurrection.launcher.responsive.CalculatedCellSpec;
import com.resurrection.launcher.responsive.CalculatedHotseatSpec;
import com.resurrection.launcher.responsive.CalculatedResponsiveSpec;
import com.resurrection.launcher.responsive.HotseatSpecsProvider;
import com.resurrection.launcher.responsive.ResponsiveCellSpecsProvider;
import com.resurrection.launcher.responsive.ResponsiveSpec.Companion.ResponsiveSpecType;
import com.resurrection.launcher.responsive.ResponsiveSpec.DimensionType;
import com.resurrection.launcher.responsive.ResponsiveSpecsProvider;
import com.resurrection.launcher.util.DisplayController;
import com.resurrection.launcher.util.DisplayController.Info;
import com.resurrection.launcher.util.IconSizeSteps;
import com.resurrection.launcher.util.ResourceHelper;
import com.resurrection.launcher.util.WindowBounds;
