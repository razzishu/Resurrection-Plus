 ...
 */
package com.resurrection.launcher.allapps;

import static com.resurrection.launcher.Flags.clearScrimOnReset;
import static com.resurrection.launcher.Flags.enableExpandingPauseWorkButton;
import static com.resurrection.launcher.allapps.ActivityAllAppsContainerView.AdapterHolder.MAIN;
import static com.resurrection.launcher.allapps.ActivityAllAppsContainerView.AdapterHolder.SEARCH;
import static com.resurrection.launcher.allapps.ActivityAllAppsContainerView.AdapterHolder.WORK;
import static com.resurrection.launcher.allapps.BaseAllAppsAdapter.VIEW_TYPE_PRIVATE_SPACE_HEADER;
import static com.resurrection.launcher.allapps.BaseAllAppsAdapter.VIEW_TYPE_WORK_DISABLED_CARD;
import static com.resurrection.launcher.allapps.BaseAllAppsAdapter.VIEW_TYPE_WORK_EDU_CARD;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ALLAPPS_COUNT;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ALLAPPS_TAP_ON_PERSONAL_TAB;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ALLAPPS_TAP_ON_WORK_TAB;
import static com.resurrection.launcher.util.Executors.MAIN_EXECUTOR;
import static com.resurrection.launcher.util.ScrollableLayoutManager.PREDICTIVE_BACK_MIN_SCALE;
import static com.resurrection.launcher.views.RecyclerViewFastScroller.FastScrollerLocation.ALL_APPS_SCROLLER;
...
import com.resurrection.launcher.DeviceProfile.OnDeviceProfileChangeListener;
...
import com.resurrection.launcher.Insettable;
import com.resurrection.launcher.InsettableFrameLayout;
import com.resurrection.launcher.R;
import com.resurrection.launcher.Utilities;
import com.resurrection.launcher.allapps.BaseAllAppsAdapter.AdapterItem;
import com.resurrection.launcher.allapps.search.AllAppsSearchUiDelegate;
import com.resurrection.launcher.allapps.search.SearchAdapterProvider;
import com.resurrection.launcher.config.FeatureFlags;
import com.resurrection.launcher.keyboard.FocusedItemDecorator;
...
import com.resurrection.launcher.util.Preconditions;
...
import com.resurrection.launcher.views.RecyclerViewFastScroller;
import com.resurrection.launcher.views.ScrimView;
import com.resurrection.launcher.views.SpringRelativeLayout;
import com.resurrection.launcher.workprofile.PersonalWorkSlidingTabStrip;
