...
import static com.resurrection.launcher.Flags.enableLauncherBrMetricsFixed;
import static com.resurrection.launcher.LauncherPrefs.IS_FIRST_LOAD_AFTER_RESTORE;
import static com.resurrection.launcher.icons.CacheableShortcutInfo.convertShortcutsToCacheableShortcuts;
import static com.resurrection.launcher.icons.cache.CacheLookupFlag.DEFAULT_LOOKUP_FLAG;
import static com.resurrection.launcher.model.FirstScreenBroadcastHelper.DISABLE_INSTALLED_APPS_BROADCAST;
import static com.resurrection.launcher.model.ModelUtils.WIDGET_FILTER;
import static com.resurrection.launcher.model.ModelUtils.currentScreenContentFilter;
import static com.resurrection.launcher.model.data.AppsListData.FLAG_HAS_SHORTCUT_PERMISSION;
import static com.resurrection.launcher.model.data.AppsListData.FLAG_PRIVATE_PROFILE_QUIET_MODE_ENABLED;
import static com.resurrection.launcher.model.data.AppsListData.FLAG_QUIET_MODE_CHANGE_PERMISSION;
import static com.resurrection.launcher.model.data.AppsListData.FLAG_QUIET_MODE_ENABLED;
import static com.resurrection.launcher.model.data.AppsListData.FLAG_WORK_PROFILE_QUIET_MODE_ENABLED;
import static com.resurrection.launcher.model.data.ItemInfoWithIcon.FLAG_INSTALL_SESSION_ACTIVE;
import static com.resurrection.launcher.util.Executors.MODEL_EXECUTOR;
import static com.resurrection.launcher.util.LooperExecutor.CALLER_LOADER_TASK;
import static com.resurrection.launcher.util.PackageManagerHelper.hasShortcutsPermission;
...
import com.resurrection.launcher.folder.FolderNameInfos;
import com.resurrection.launcher.folder.FolderNameProvider;
import com.resurrection.launcher.homescreenfiles.HomeScreenFile;
import com.resurrection.launcher.homescreenfiles.HomeScreenFilesProvider;
import com.resurrection.launcher.icons.CacheableShortcutCachingLogic;
import com.resurrection.launcher.icons.CacheableShortcutInfo;
import com.resurrection.launcher.icons.IconCache;
import com.resurrection.launcher.icons.cache.CachedObject;
import com.resurrection.launcher.icons.cache.CachedObjectCachingLogic;
import com.resurrection.launcher.icons.cache.IconCacheUpdateHandler;
import com.resurrection.launcher.icons.cache.LauncherActivityCachingLogic;
...
import com.resurrection.launcher.model.data.IconRequestInfo;
...
import com.resurrection.launcher.pm.UserCache.CachedUserInfo;
import com.resurrection.launcher.pm.UserManagerState;
import com.resurrection.launcher.provider.LauncherDbUtils;
import com.resurrection.launcher.shortcuts.ShortcutKey;
import com.resurrection.launcher.shortcuts.ShortcutRequest;
import com.resurrection.launcher.shortcuts.ShortcutRequest.QueryResult;
import com.resurrection.launcher.util.ApiWrapper;
import com.resurrection.launcher.util.IOUtils;
import com.resurrection.launcher.util.IntArray;
import com.resurrection.launcher.util.IntSet;
import com.resurrection.launcher.util.LooperIdleLock;
