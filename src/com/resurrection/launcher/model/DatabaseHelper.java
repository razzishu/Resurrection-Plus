...
import static com.resurrection.launcher.util.SQLiteCacheHelper.createNoLocaleParams;
...
import com.resurrection.launcher.AutoInstallsLayout.LayoutParserCallback;
...
public class DatabaseHelper extends SQLiteOpenHelper implements
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        switch (oldVersion) {
            // The version cannot be lower that 12, as resurrection never supported a lower
            // version of the DB.
            case 12:
                // No-op
            case 13: {
