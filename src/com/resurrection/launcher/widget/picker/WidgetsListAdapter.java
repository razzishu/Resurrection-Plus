...
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_WIDGETSTRAY_APP_EXPANDED;
import static com.resurrection.launcher.recyclerview.ViewHolderBinder.POSITION_DEFAULT;
import static com.resurrection.launcher.recyclerview.ViewHolderBinder.POSITION_FIRST;
import static com.resurrection.launcher.recyclerview.ViewHolderBinder.POSITION_LAST;
import static com.resurrection.launcher.widget.BaseWidgetSheet.DEFAULT_MAX_HORIZONTAL_SPANS;
...
import com.resurrection.launcher.util.LabelComparator;
import com.resurrection.launcher.util.PackageUserKey;
import com.resurrection.launcher.views.ActivityContext;
import com.resurrection.launcher.widget.model.WidgetListSpaceEntry;
...
import com.resurrection.launcher.widget.model.WidgetsListExpandActionEntry;
import com.resurrection.launcher.widget.model.WidgetsListHeaderEntry;
import com.resurrection.launcher.widget.util.WidgetSizes;
...
public class WidgetsListAdapter extends Adapter<ViewHolder> implements OnHeaderClickListener {
    ...
    /** Gets the section name for {@link com.resurrection.launcher.views.RecyclerViewFastScroller}. */
