...
import static com.resurrection.launcher.Flags.enableLauncherVisualRefresh;
...
import static com.resurrection.launcher.compat.AccessibilityManagerCompat.sendCustomAccessibilityEvent;
import static com.resurrection.launcher.config.FeatureFlags.ALWAYS_USE_HARDWARE_OPTIMIZATION_FOR_FOLDER_ANIMATIONS;
import static com.resurrection.launcher.folder.FolderGridOrganizer.createFolderGridOrganizer;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_FOLDER_LABEL_UPDATED;
import static com.resurrection.launcher.logging.StatsLogManager.LauncherEvent.LAUNCHER_ITEM_DROP_COMPLETED;
import static com.resurrection.launcher.model.data.FolderInfo.willAcceptItemType;
...
import static com.resurrection.launcher.testing.shared.TestProtocol.FOLDER_OPENED_MESSAGE;
import static com.resurrection.launcher.util.window.RefreshRateTracker.getSingleFrameMs;
...
import com.resurrection.launcher.AbstractFloatingView;
import com.resurrection.launcher.Alarm;
import com.resurrection.launcher.CellLayout;
import com.resurrection.launcher.DeviceProfile;
import com.resurrection.launcher.DragSource;
import com.resurrection.launcher.DropTarget;
import com.resurrection.launcher.ExtendedEditText;
...
import com.resurrection.launcher.ShortcutAndWidgetContainer;
import com.resurrection.launcher.Utilities;
import com.resurrection.launcher.accessibility.AccessibleDragListenerAdapter;
import com.resurrection.launcher.accessibility.FolderAccessibilityHelper;
import com.resurrection.launcher.anim.KeyboardInsetAnimationCallback;
...
import com.resurrection.launcher.dragndrop.DragController.DragListener;
import com.resurrection.launcher.dragndrop.DragOptions;
import com.resurrection.launcher.graphics.ShapeDelegate;
import com.resurrection.launcher.graphics.ThemeManager;
import com.resurrection.launcher.logger.LauncherAtom.FromState;
import com.resurrection.launcher.logger.LauncherAtom.ToState;
import com.resurrection.launcher.logging.StatsLogManager;
import com.resurrection.launcher.logging.StatsLogManager.StatsLogger;
...
import com.resurrection.launcher.pageindicators.PageIndicatorDots;
...
import com.resurrection.launcher.views.BaseDragLayer;
import com.resurrection.launcher.views.ClipPathView;
