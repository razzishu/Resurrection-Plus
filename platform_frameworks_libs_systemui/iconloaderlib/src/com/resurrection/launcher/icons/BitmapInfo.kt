...
import com.resurrection.launcher.icons.BitmapInfo.Companion.FLAG_THEMED
import com.resurrection.launcher.icons.FastBitmapDrawableDelegate.DelegateFactory
import com.resurrection.launcher.icons.FastBitmapDrawableDelegate.SimpleDelegateFactory
import com.resurrection.launcher.icons.PlaceHolderDrawableDelegate.PlaceHolderDelegateFactory
...
data class BitmapInfo(
    ...
    companion object {
        ...
        // LINT.ThenChange(src/com.resurrection.launcher/icons/cache/BaseIconCache.kt:cache_release_version)
